...
BEGIN
    ...
    -- Insertar algunos datos de ejemplo (SIN especificar IdEstatus, se genera autom�ticamente)
    INSERT INTO [dbo].[Agenda_Estatus] ([NombreEstatus], [Descripcion], [Activo]) 
    VALUES
    (N'Pendiente', N'Estado inicial, esperando atencion', 1),
    (N'En Proceso', N'Se est� trabajando en la tarea', 1),
...
BEGIN
    ...
    -- INSERT INTO [dbo].[Agenda_Estatus] ([NombreEstatus], [Descripcion], [Activo]) 
    -- VALUES
    -- (N'Pendiente', N'Estado inicial, esperando atenci�n', 1),
    -- (N'En Proceso', N'Se est� trabajando en la tarea', 1),
    -- (N'Completado', N'Tarea finalizada exitosamente', 1),
    -- (N'Cancelado', N'La tarea fue cancelada', 1),
    -- (N'En Espera', N'Esperando informaci�n o recursos adicionales', 1)
END
GO
